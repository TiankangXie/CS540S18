...
//        }
        ...
        if (mode == 0) {
            (new DecisionTreeImpl()).rootInfoGain(createDataSet("examples1.txt"));
            return;
        }
        ...
        DataSet trainSet = createDataSet("examples1.txt");

        DataSet testSet = null;
        if (mode == 2 || mode == 3) {
            testSet = createDataSet("examples2.txt");
